...
model = configured_model("deepritz")


result=test_optimizers(model = model, optimizer_list=optimizerlist, plot=True, savedata=True, savefig=True, save_logs=True, heading = "Deep Ritz method for 10d Poisson equation")