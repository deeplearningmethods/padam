...
model = configured_model("polyreg")


result=test_optimizers(model = model, optimizer_list=optimizerlist, plot=True, savedata=True, savefig=True, save_logs=True, heading = "Polynomial regression")