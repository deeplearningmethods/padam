...
model = configured_model("BurgersPINN1d")


result=test_optimizers(model = model, optimizer_list=optimizerlist, plot=True, savedata=True, savefig=True, save_logs=True, heading = "PINNs for Burgers equation")