...
model = configured_model("optimalcontrol")


result=test_optimizers(model = model, optimizer_list=optimizerlist, plot=True, savedata=True, savefig=True, save_logs=True, heading = "Optimal Control Problem")