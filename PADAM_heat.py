...
model = configured_model("heat")


result=test_optimizers(model = model, optimizer_list=optimizerlist, plot=True, savedata=True, savefig=True, save_logs=True, heading = "Deep Kolmogorov Method for 10d Heat equation")